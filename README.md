...
[![Amazon ElastiCache](https://img.shields.io/badge/Amazon_ElastiCache_Valkey-C7131F?logo=redis&logoColor=white)](https://aws.amazon.com/elasticache/)
...
* **Caching de Alta Performance (ElastiCache Valkey):** Padrão **Cache-Aside** (*Lazy Loading*) com nó Valkey na VPC para respostas de leitura em submilissegundos e invalidação explícita no ciclo de vida de atualizações.
...
* **Garantia de Qualidade Multi-Camadas (Shift-Left QA):**
  ...
  * **Infraestrutura Java:** Testes de asserção da stack CDK (S3, VPC, Valkey, DynamoDB) usando **JUnit 5**.
...
A cada módulo concluído, a arquitetura evolui de forma incremental. O diagrama abaixo representa o estado atual do sistema com borda tratada, upload de mídias via Presigned URLs, processamento por eventos S3, caching em memória com Valkey e resiliência no DynamoDB:
...
| **2** | **6. Scaling with Data Storage** | Concluído 🌟 | Amazon S3, ElastiCache Valkey, Presigned URLs, Cache-Aside | `v6.0.0` | [Acessar Docs](./docs/04-scaling-data-storage/README.md) |
...
│   └── 04-scaling-data-storage/        # Módulo 06: Amazon S3 & ElastiCache Valkey Caching
...
│   ├── vendor/                         # Dependências locais isoladas para testes e LocalStack
...
# Exemplo de solicitação de Presigned URL de upload
...
# Exemplo de upload direto da mídia para o Amazon S3
...
* 📜 **[ADR 0004: Scaling with Amazon S3 & ElastiCache Valkey Caching](./adr/0004-add-s3-and-elasticache-with-cache-aside.md)**
